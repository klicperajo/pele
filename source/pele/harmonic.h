...
double inline BaseHarmonic::get_energy(pele::Array<double> const & x, const bool soa)
{
...
double inline BaseHarmonic::get_energy_gradient(pele::Array<double> const & x, pele::Array<double> & grad, const bool soa)
{
